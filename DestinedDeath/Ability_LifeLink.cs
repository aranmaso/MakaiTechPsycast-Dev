            ...
            if (rollinfo.roll >= modExtension.successThreshold && rollinfo.roll < modExtension.greatSuccessThreshold)
            {
                foreach (GlobalTargetInfo globalTargetInfo in targets)
                {
                    ...
                    if (globalTargetInfo.Thing is Pawn linkedPawn)
                    {
                        ...
                        Hediff hediff = MakaiUtility.CreateCustomHediffWithDurationNoMultiplier(linkedPawn, modExtension.hediffDefWhenSuccess, modExtension.hours, modExtension.ticks);
